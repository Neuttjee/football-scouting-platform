...
export const playerTargetFieldsInternal: ImportTargetField[] = [
  ...
  { key: "joinedAt", label: "Bij club sinds (seizoen)", type: "string" },
  { key: "contractEndDate", label: "Contract tot (seizoen)", type: "string" },
...
export const playerFieldAliases: Record<string, string[]> = {
  ...
  contractEndDate: ["contract tot", "contract end", "einde contract", "end date", "seizoen einde", "season end"],
